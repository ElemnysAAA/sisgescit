    ...
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          ...
          <a href="Crearusuarios.php" class="btn btn-primary">Crear Nuevo Usuario</a>
        </div>
        <div class="col-sm-6">
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      <a href="editarusuarios.php?id=<?php echo $fila['id']; ?>" class="btn btn-primary">Editar</a>
                    </td>
                    <td>
                      <?php if ($fila['estado'] == 1): ?>
                        <span class="badge bg-success">Activo</span>
                        <a href="model/estado_usuario.php?id=<?php echo $fila['id']; ?>&estado=0" class="btn btn-warning" id="btn-desc">Desactivar</a>
                      <?php else: ?>
                        <span class="badge bg-danger">Inactivo</span>
                        <a href="model/estado_usuario.php?id=<?php echo $fila['id']; ?>&estado=1" class="btn btn-success" id="btn-btn">Activar</a>
                      <?php endif; ?>
                    </td>
                  </tr>
                <?php } ?>
